...
public class SecurityConfig {
    ...
    // cost factor 12 (vs BCrypt's default 10) is a deliberate choice trading a bit of extra hashing latency for stronger resistance to offline brute-force attacks if the password hash table ever leaked, and that auth endpoints are relatively low-traffic so this tradeoff is worth it.
    @Bean
